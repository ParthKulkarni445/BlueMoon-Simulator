...
class _EditorTabState extends State<EditorTab> {
  ...
  void _saveCodeToSimulator() {
    ...
    try {
      // Format the code for the simulator
      //final formattedCode = _formatCodeForSimulator(_codeController.text);

      // Reset the simulator before loading new code
      _simulator.reset();

      // Load the code into the simulator
      _simulator.loadCode(_codeController.text);
